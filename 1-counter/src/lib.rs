...
mod test {
    ...
    fn test_counter() {
        ...
        //Increment the counter by 22
        increment_instruction_data.extend_from_slice(&22u32.to_le_bytes());
        ...
        decrement_instruction_data.extend_from_slice(&10u32.to_le_bytes());
        ...
        //Reset if overflow/underflow
        decrement_instruction_data = vec![1];
        decrement_instruction_data.extend_from_slice(&300u32.to_le_bytes());
        ...
        //Update to an arbitrary value

        let update_value = 200u32;
